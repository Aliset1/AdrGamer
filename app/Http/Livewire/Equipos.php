...
class Equipos extends Component
{
    ...
    public function enpie(Request $request, $id)
    {
        ...
        if($this->enjuego=="Si")
        {
            session()->flash('message', 'El equipo', isset($_GET[$record->nombre]),'Siguen participando') ;
        }

        else{
            session()->flash('message', 'El equipo ', isset($_GET[$record->nombre]),'ya no esta participando') ;
        }
